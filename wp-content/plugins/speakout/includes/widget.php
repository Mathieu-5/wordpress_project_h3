			...
			if ( $expired ) {
				...
				// do we display honorific?
					if ( $options['display_honorific'] == 'enabled' ) {
						$petition_widget .='    <div class="dk-speakout-widget-full">
								<label for="dk-speakout-widget-honorific-' . $petition->id . '" class="required">' . __( 'Title', 'speakout' ) . '</label>
                                    <select name="dk-speakout-widget-honorific" id="dk-speakout-widget-honorific-' . $petition->id . '">
				...
				$petition_widget .= '
							...
							<div class="dk-speakout-widget-full">
								...
								<input name="dk-speakout-widget-email" id="dk-speakout-widget-email-' . $petition->id . '" value="' . $userdata['email'] . '" type="email" />
							</div>';
				if ( $petition->requires_confirmation ) {
					$petition_widget .= '
							<div class="dk-speakout-widget-full">
								...
								<input name="dk-speakout-widget-email-confirm" id="dk-speakout-widget-email-confirm-' . $petition->id . '" value="" type="email" />
							</div>';
				}
