		...
		if ( $petition_exists ) {
			...
			if ( isset($options['display_recaptcha']) && $options['display_recaptcha'] == 'enabled' ) {
				...
				$petition_form .= '<div class="dk-speakout-full">
								...
								<input name="dk-speakout-email" id="dk-speakout-email-' . $petition->id . '" value="' . $userdata['email'] . '" type="email" />
							</div>';
				...
				if ( $petition->requires_confirmation ) {
					$petition_form .= '
							<div class="dk-speakout-full">
								...
								<input name="dk-speakout-email-confirm" id="dk-speakout-email-confirm-' . $petition->id . '" value="" type="email" />
							</div>';
				}
				...
				if ( $options['display_privacypolicy'] == 'enabled' ) {
				    $petition_form .= '
								...
								<div><input type="checkbox" name="dk-speakout-privacypolicy" id="dk-speakout-privacypolicy" class="required" />
