...
function dk_speakout_create_menus() {
	...
	add_submenu_page( "dk_speakout", $petitions['page_title'], __( 'Petitions', 'speakout' ), $petitions['capability'], $petitions['menu_slug'], $petitions['function'], $petitions['icon_url'] );
