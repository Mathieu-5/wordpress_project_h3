	...
	<table class="widefat">
		...
		<tbody>
			...
			<tr class="dk-speakout-tablerow">
				...
				<td><?php echo stripslashes( esc_html( $signature->title ) ); ?> <?php if($petitions_list && count( $petitions_list) > 1 ){ echo "(#" . $signature->petitions_id . ")"; } ?></td>
				<td><?php echo $confirmed; ?></td>
				<td><?php echo $optin; ?></td>
				<td><?php echo ucfirst( date_i18n( 'M d, Y', strtotime( $signature->date ) ) ); ?></td>
                <td><?php echo $signature->IP_address ; ?></td>
