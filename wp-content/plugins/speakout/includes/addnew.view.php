				...
				<div class="inside">
					...
					<div class="dk-speakout-petition-content">
						<div class="dk-speakout-email-headers">
							<label for="target_email"><?php _e( 'Target Email', 'speakout' ); ?> <span class='normalText'><?php _e( 'you may enter multiple addresses separated by commas', 'speakout' ); ?></span></label> 
					...
					<div id="minor-publishing">
						...
						<div class="misc-pub-section">
							...
							<div class="dk-speakout-address dk-speakout-subsection <?php if( count( $petition->address_fields ) == 0 ) echo 'dk-speakout-hidden'; ?>">
								...
								<label for="postcode"><?php _e( 'Postal Code', 'speakout'); ?></label><br/>
						...
						<div class="misc-pub-section">
							...
							</div><?php _e( 'This field is included in email to target', 'speakout'); ?><br />
							<div class="dk-speakout-custom-field dk-speakout-subsection <?php if( $petition->displays_custom_field != 1 ) echo 'dk-speakout-hidden'; ?>"><br />
								...
								<br />Location<br /><input type="radio" name="custom-field-location" id="custom-field-location-top" value="1" <?php if ($petition->custom_field_location == 1) {echo " CHECKED";} ?> />
						...
						<div class="misc-pub-section">
							...
							</div><?php _e( 'Displayed beneath `Thank you` after petition is signed', 'speakout'); ?><br />
