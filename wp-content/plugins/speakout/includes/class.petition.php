...
class dk_speakout_Petition
{
	...
	public function create()
	{
		...
		$data = array(
			...
			$format = array( '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%d', '%s', '%s', '%d', '%d', '%s', '%d', '%d', '%d', '%s', '%d', '%d', '%s', '%d', '%s', '%d' );
	...
	public function populate_from_post()
	{
		...
		if ( isset( $_POST['target_email_CC'] ) ) {
			$this->target_email_CC = $_POST['target_email_CC'];
		}
		...
		if ( isset( $_POST['petition_footer'] ) ) {
			$this->petition_footer = $_POST['petition_footer'];
		}
		if ( isset( $_POST['bcc'] ) ) {
			$this->bcc = $_POST['bcc'];
		}
		...
		if ( isset( $_POST['custom-field-location'] ) ) {
			$this->custom_field_location = $_POST['custom-field-location'];
		}
