						        		...
						        		if(data.meta.code === 200 && data.data.length) {
							        		...
							        		for(var i = 0; i < data.data.length; i++) {
							        			...
							        			if(thisMedia.type === 'image' || !s.videos) {
								        			...
								        			// construct image
								        			item = '<img class="il-photo_img" src="'+thisMedia.images.standard_resolution.url+'" alt="Instagram Image" data-filter="'+thisMedia.filter+'" />';
								        			...
								        			if(s.captions || s.date || s.likes || s.comments_count) {
									        			item += '<div class="il-photo_meta">';
								        			}
								        			
								        			// if caption setting is true
								        			if(s.captions && thisMedia.caption) {
								        			
								        				item += '<div class="il-photo_caption" data-caption-id="'+thisMedia.caption.id+'">'+formatCaption(thisMedia.caption.text)+'</div>';
								        			...
								        			if(s.likes) {
								        				...
								        				item += '<div class="il-photo_likes"> ♥ '+thisMedia.likes.count+'</div>';
								        			...
								        			if(s.comments_count && thisMedia.comments) {
								        				...
								        				item += '<div class="il-photo_comments">'+thisMedia.comments.count+'</div>';
							        			...
							        			if(s.list && item) {
							        				...
							        				item = '<li class="il-item insta-item-list" data-instagram-id="'+thisMedia.id+'">'+item+'</li>';
							        			}
...
jQuery(document).ready(function($){
  $('button').on('click', loadBar)
  
  function loadBar(){
    $('button').contents().after('<span class="loading-bar gradient-animate white px1"><i class="fa fa-spinner fa-spin white"></i> </span>')
    setTimeout(function(){
      $('.loading-bar').remove();
    }, 1000);
  }
