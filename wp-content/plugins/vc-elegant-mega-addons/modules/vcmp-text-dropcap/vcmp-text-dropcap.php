...
class VcmpTextDropcap extends VcmpModule{

	const slug = 'vcmp_text_dropcap';
	const base = 'vcmp_text_dropcap';
	...
	public function vc_before_init(){
		vc_map( array(
			'name' 			=> __('Dropcaps', VCMP_SLUG),
			"description" 	=> __("Add text dropcaps to your page.", "VCMP_SLUG"),
			"base" 			=> self::base,
			"class" 		=> "",
					...
					array(
						...
						'settings'=>array(
						    'fields'=>array(
						        ...
						        'color',
						        'font_style',
						        'font_size_description' => __('Dropcap letter font size.', 'VCMP_SLUG'),
						        'line_height_description' => __('Dropcap letter line height.', 'VCMP_SLUG'),
						        'color_description' => __('Dropcap letter color.','js_composer'),
								'admin_label' => true,
						        'font_style_description' => __('Dropcap letter style.', 'VCMP_SLUG')
						    ),
						),
					),
					array(
